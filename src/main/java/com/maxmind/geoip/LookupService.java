...
public class LookupService {
    ...
    public static HashMap getHashmapcountrycodetoindex() {
		return hashmapcountryCodetoindex;
	}
    
    public static HashMap getHashmapcountrynametoindex() {
		return hashmapcountryNametoindex;
	}
